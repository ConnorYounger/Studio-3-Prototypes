        ...
        */
        ...
        protected override void HandleMotion()
        {
            ...
            if (distance < cachedMotionDistance)
            {
                ...
                if (IsInMotionWithoutProgress(1.5f))
                {
                    ResetMotion();
                    return;
                }
        ...
        {
            float velo = controller.getCharController().velocity.x + controller.getCharController().velocity.y +
                         controller.getCharController().velocity.z;

            return velo > -treshold && velo < treshold;
        }
